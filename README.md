...
- **TECH_STACK_PROPOSAL.md** - Технологический стек
- **DEVELOPMENT_PLAN.md** - План разработки
- **OLD_PROJECT_SUMMARY.md** - Анализ старого проекта
- **DEVELOPMENT_HISTORY.md** - История разработки
- **AI_SOLUTION.md** - Решение по AI
- **SESSION_1_SUMMARY.md** - Итоги первой сессии
