...
async def test_groq_analysis():
    ...
    test_posts = [
        {
            "id": 1,
            "text": "В регионе действует 40 пунктов проката технических средств реабилитации для инвалидов и пожилых людей",  # noqa: E501
        },
        {
            "id": 2,
            "text": "Продаются 6-ти месячные индоутки тяжёлой линии. Красный бык, уточки 1500, селезни 2500. 89172715085",  # noqa: E501
        },
        {
            "id": 3,
            "text": "Администрация района объявляет о проведении общественных слушаний по вопросу строительства нового детского сада",  # noqa: E501
        },
    ]
