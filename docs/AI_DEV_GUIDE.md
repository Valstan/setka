...
**Удалённый продакшен:** работать **через SSH** на хост SETKA в первую очередь; MCP в IDE — опционально и только если это тот же хост. Подробно: [`REMOTE_ACCESS.md`](REMOTE_ACCESS.md).
...
| [`REMOTE_ACCESS.md`](REMOTE_ACCESS.md) | SSH в приоритете, MCP запасной; только хост SETKA |
...
| [`MCP_SETUP_VSCODE.md`](MCP_SETUP_VSCODE.md) | Опционально: MCP в VS Code (после `REMOTE_ACCESS.md`) |
