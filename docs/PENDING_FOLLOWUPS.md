...
**Скелетно готовы 15 районов** (миграции 061-065 применены, регионы `is_active=false`, `vk_group_id NULL`,
...
Орлов 9; №5 — Слободской 28 / Кирово-Чепецк 25 / Белая Холуница 18. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 15 районов (Яранск,
  Санчурск, Кикнур, Суна, Богородское, Кумёны, Зуевка, Фалёнки, Уни, Оричи, Орлов, Котельнич,
  Слободской, Кирово-Чепецк, Белая Холуница) с основного аккаунта,
...
- 🟢 **Батч №6+:** остальные ~12 районов (Даровской, Свеча, Шабалино, Мураши, Юрья, Нагорск,
  Омутнинск, Афанасьево, Верхнекамье, Луза, Подосиновец, Опарино) — тем же конвейером. Заделы:
  соцзащита Котельничского района (club71143011) — донор Свече/Даровскому; «С.Боровица
  Мурашинский район» (club185507097) → `murashi`.
