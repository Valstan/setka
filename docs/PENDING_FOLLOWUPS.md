...
- ✅ **Стат-замер охвата выполнен 2026-06-24** (probe `scripts/probe_krugozor_reach.py`, read-only
  `wall.get`+baseline-сравнение, 16/16 регионов, 66 дайджестов за 6 дней). **Итог: оставить 1×
  пока.** Дайджест читают (overall median **180** просмотров/пост, в крупных районах 300+), но в
