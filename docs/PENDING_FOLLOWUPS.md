...
- 🟡 **Архивирование остатка завала** (решение владельца 2026-08-18, после дистилляции): посты старше
  72 часов публиковать поздно, ценность только обучающая. Пометить оставшиеся неразобранные архивными
  одним ходом. **Это UPDATE на десятках тысяч строк прода — под гейтом #025**, с явным
  подтверждением и обратимым признаком (не DELETE). Сначала утверждение правил, потом архив.
- 🟢 **Живой движок прочитан по двум пластам** (18.08): `соседи` целиком (113 постов) и
  ...
  (гигиена файла: не добавлять правило под единичный случай). Решения владителя 18.08 по двум
