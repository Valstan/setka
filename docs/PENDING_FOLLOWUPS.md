...
- **Инкрементально ломать длинные строки, помеченные `# noqa: E501`** — PR 2 закрыл E501 через массовый noqa, но real-формат можно улучшать постепенно. Прогресс:
  - ✅ **2026-05-24 PR #1**: `modules/system_status_notifier.py` — 15 noqa → 0.
  - ✅ **2026-05-24 PR #2**: `tasks/parsing_tasks.py` — 10 noqa → 0.
  - ✅ **2026-05-24 PR #3**: `tasks/vk_carousel_tasks.py` (4) + `modules/service_activity_notifier.py` (4) — 8 noqa → 0.
  - **Осталось: 63 noqa в 40 файлах.** Следующие густые: `scripts/run_production_workflow.py` (4), `modules/test_info_post_collector.py` (3), `modules/vk_monitor/carousel_manager.py` (3), `scripts/test_ai_groq.py` (3), `scripts/test_parse_run.py` (3), `tasks/production_workflow_tasks.py` (3), `config/runtime.py` (3), остальные 33 файла по 1-2 noqa.
