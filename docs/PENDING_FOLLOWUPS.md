...
- ✅ **Построено + ЗАДЕПЛОЕНО + ВКЛЮЧЕНО 2026-06-14** (PR [#230](https://github.com/Valstan/setka/pull/230)/[#231](https://github.com/Valstan/setka/pull/231)/[#232](https://github.com/Valstan/setka/pull/232)/[#233](https://github.com/Valstan/setka/pull/233)): `modules/krugozor_broadcast.py` —
  **дайджест-режим** (финальная форма): за прогон ротацией собирает 2-4 свежих поста из
  ...
  первый дайджест верифицирован (4 источника). +дайджест/промо тесты (1342 зелёных).
...
- 🟢 **Стат-замер охвата → 1× vs 2×** (эмпирически): после ~недели посчитать просмотры/лайки
  → зайдёт → добавить обеденный слот 13:00. Многие источники постят видео → грид часто пуст
  (видео не рехостится, идёт текст+ссылка) — это норма.
