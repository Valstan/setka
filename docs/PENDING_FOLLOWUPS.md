...
### 🌍 Экспансия на всю Кировскую область — 24 района скелетом, ждут групп VK (заказ владельца 2026-07-18)

`⏱ 2026-07-18 · snooze 0 · parked (ждёт разбана VALSTAN 2026-07-20)`

Цель — добрать все ~27 оставшихся районов области. Порядок — от соседей текущего кластера.
**Скелетно готовы 24 района** (миграции 061-068 применены, регионы `is_active=false`, `vk_group_id NULL`,
...
Афанасьево 25. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 24 районов (Яранск,
...
- 🟢 **Батч №9 (финал):** последние 3 северо-западных района (Луза, Подосиновец, Опарино) —
  тем же конвейером. После него область скелетом закрыта целиком.
