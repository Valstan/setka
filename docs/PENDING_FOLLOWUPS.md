...
### 🌍 Экспансия на всю Кировскую область — батчи №1-3 (9 районов) ждут групп VK (заказ владельца 2026-07-18)
...
**Скелетно готовы 18 районов** (миграции 061-066 применены, регионы `is_active=false`, `vk_group_id NULL`,
...
Шабалино 23 / Свеча 8. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 18 районов (Яранск,
  Санчурск, Кикнур, Суна, Богородское, Кумёны, Зуевка, Фалёнки, Уни, Оричи, Орлов, Котельнич,
  Слободской, Кирово-Чепецк, Белая Холуница, Даровской, Свеча, Шабалино) с основного аккаунта,
...
- 🟢 **Батч №7+:** остальные ~9 северных районов (Мураши, Юрья, Нагорск, Омутнинск, Афанасьево,
  Верхнекамье/Кирс, Луза, Подосиновец, Опарино) — тем же конвейером. Заделы: «С.Боровица
  Мурашинский район» (club185507097) → `murashi`; ДК «Металлург» Омутнинск (club199848219) →
  `omutninsk`; магазины «Раздолье» упоминали Афанасьевское райпо.
