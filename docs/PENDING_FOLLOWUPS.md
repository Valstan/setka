...
**Скелетно готов 21 район** (миграции 061-067 применены, регионы `is_active=false`, `vk_group_id NULL`,
...
Шабалино 23 / Свеча 8; №7 — Юрья 20 / Мураши 14 / Нагорск 9. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 21 района (Яранск,
...
- 🟢 **Батч №8+ (финал):** остальные ~6 северо-восточных/северо-западных районов (Омутнинск,
  Афанасьево, Верхнекамье/Кирс, Луза, Подосиновец, Опарино) — тем же конвейером. Задел:
  ДК «Металлург» Омутнинск (club199848219) → `omutninsk`.
