...
**Скелетно готовы 12 районов** (миграции 061-064 применены, регионы `is_active=false`, `vk_group_id NULL`,
...
Орлов 9. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 12 районов (Яранск,
  Санчурск, Кикнур, Суна, Богородское, Кумёны, Зуевка, Фалёнки, Уни, Оричи, Орлов, Котельнич) с основного аккаунта,
...
- 🟢 **Батч №5+:** остальные ~15 районов (Слободской, Белая Холуница, Кирово-Чепецк, Даровской,
  Свеча, Шабалино, Мураши, Юрья, Нагорск, Омутнинск, Афанасьево, Верхнекамье, Луза, Подосиновец,
  Опарино) — тем же конвейером. Заделы: «БЕЛАЯ ХОЛУНИЦА» (club34638119); соцзащита Котельничского
  района (club71143011, межрайонная) — донор Свече/Даровскому; орловские/оричевские пулы дадут
  соседский обмен западному крылу.
