...
**Скелетно готовы 9 районов** (миграции 061-063 применены, регионы `is_active=false`, `vk_group_id NULL`,
брендинг+localities в region_configs): №1 — Яранск 30 / Санчурск 14 / Кикнур 8; №2 — Суна 24 /
Кумёны 23 / Богородское 9; №3 — Зуевка 19 / Уни 9 / Фалёнки 8. Журнал — `docs/REGION_REFRESH_LOG.md`.

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «- ИНФО» для 9 районов (Яранск,
  Санчурск, Кикнур, Суна, Богородское, Кумёны, Зуевка, Фалёнки, Уни) с основного аккаунта,
...
- 🟢 **Батч №4+:** остальные ~18 районов (Оричи, Котельнич, Орлов, Слободской, Белая Холуница,
  Кирово-Чепецк, Даровской, Свеча, Шабалино, Мураши, Юрья, Нагорск, Омутнинск, Афанасьево,
  Верхнекамье, Луза, Подосиновец, Опарино) — тем же конвейером. Задел: паблик «БЕЛАЯ ХОЛУНИЦА»
  (club34638119) уже найден.
