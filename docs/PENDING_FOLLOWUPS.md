...
- 🟢 **За владельцем (нужно для полной силы каскада):** назначить Виту
  (id 506924717) **редактором** во всех 16 районных сообществах руками в VK
  (Управление → Участники → Руководители) — иначе VK не примет от неё wall.post
  при отказе community-токена и VALSTAN. Код готов, ждёт только прав в VK.
