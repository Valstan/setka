...
`⏱ 2026-08-09 · snooze 0 · fresh · кусок A сделан (PR ниже), дальше D; ждём слова brain по куску C`
...
**Что осталось до первого живого POST:** положить ключ DeepSeek, включить `CONVEYOR_SITES=vmalmyzhe`,
прогнать `dry_run` на живых данных, затем один пост и глазами посмотреть черновик в админке портала.
