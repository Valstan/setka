...
**Наблюдение для правил сайта:** 5 из 18 ушли в `istoriya-malmyzha`, но это «День воинской славы» из
одной группы — федеральный календарь, а не история Малмыжа. Кандидат в `rules/<site>.md`.

**Дальше:** взгляд владельца на черновики → правка промпта при необходимости → кусок C (ключ «сайт»)
после слова brain.
