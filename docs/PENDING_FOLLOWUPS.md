...
### 🎙 Модуль аудио → текст в Сарафане (исследование 2026-06-22, решение за владельцем)

`⏱ 2026-06-22 · snooze 0 · fresh · ждёт выбора архитектуры владельцем`
...
**Следующий шаг:** владелец выбирает **B** или **C** → расписать конкретный план под
выбранную архитектуру (резак на ffmpeg переиспользует паттерн `parsing`: job в Redis +
`run_coro` + FileResponse).
