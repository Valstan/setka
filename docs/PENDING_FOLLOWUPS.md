...
### 🔴 Вход через ВКонтакте сломан во всей экосистеме: `RADAR_ID_VK_APP_ID` указывает на несуществующее приложение

`⏱ 2026-07-25 · snooze 0 · fresh · нужен ход владельца (где заведено приложение 54666252?)`
