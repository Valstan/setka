...
- 🟢 **Проверить выхлоп нового пула** через сутки после 2026-07-22: у активных `yaransk` / `kiknur`
  / `sanchursk` сравнить число собранных постов в `collected_post_audit` до и после добора —
  выросло ли (особенно у Яранска: +13 источников, включая главный паблик района).
  `⏱ 2026-07-22 · snooze 0 · fresh`
