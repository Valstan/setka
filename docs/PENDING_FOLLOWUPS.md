...
- ⏳ **Смежное: `GROQ_API_KEY` скомпрометирован и не ротирован** (решение «не ротировать» принято
  2026-08-09 при двух живых потребителях). Мандат D-024 (перевод рутинных нейро-вызовов на DeepSeek)
  убирает обоих потребителей — после него ключ можно отозвать, а не ротировать.
