...
### 🌍 Экспансия на всю Кировскую область — скелет 27 районов готов, первые 3 активированы (заказ владельца 2026-07-18)

`⏱ 2026-07-21 · snooze 0 · active rollout (батч №1 в проде)`
...
- ⏸ **Следующие батчи:** создать VK-группы «- ИНФО» для оставшихся 17 районов (Суна,
  Богородское, Кумёны, Зуевка, Фалёнки, Уни, Оричи, Орлов, Котельнич,
  Слободской, Кирово-Чепецк, Даровской, Свеча, Шабалино, Мураши, Юрья, Нагорск)
