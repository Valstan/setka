...
### 🌍 Экспансия на всю Кировскую область — батчи №1-2 (6 районов) ждут групп VK (заказ владельца 2026-07-18)
...
**Скелетно готовы 6 районов** (миграции 061+062 применены, регионы `is_active=false`, `vk_group_id NULL`,
брендинг+localities в region_configs): батч №1 — Яранск 30 / Санчурск 14 / Кикнур 8 доноров;
батч №2 — Суна 24 / Кумёны 23 / Богородское 9. Журнал — `docs/REGION_REFRESH_LOG.md` (записи 2026-07-18).

- ⏸ **Owner после 20.07 (разбан VALSTAN):** создать VK-группы «ЯРАНСК - ИНФО», «САНЧУРСК - ИНФО»,
  «КИКНУР - ИНФО», «СУНА - ИНФО», «БОГОРОДСКОЕ - ИНФО», «КУМЁНЫ - ИНФО» с основного аккаунта,
...
- 🟡 **Добор пробелов пулов:** yaransk — detsad/sosed 0; sanchursk — администрация округа в VK
  не найдена, detsad/reklama 0; kiknur — администрация не найдена, пул тонкий (8);
  bogorodskoe — администрация округа не найдена, detsad/sport 0, пул тонкий (9). Добирать
  локальным знанием / повторным сканом после запуска. + добор `verhoshizhem`: найдена группа
  «Касино, Мухачи, Заложане» (club206802565, Верхошижемский район).
- 🟢 **Батч №3+:** остальные ~21 район (Оричи, Котельнич, Орлов, Зуевка, Фалёнки, Уни, Слободской,
  Кирово-Чепецк…) — по канону из `REGION_REFRESH_LOG.md`, тем же конвейером. Соцзащита
  Зуевка-Фалёнки-Богородское-Уни уже найдена (донор для трёх будущих районов).
