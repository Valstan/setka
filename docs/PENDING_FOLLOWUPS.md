...
- 🟢 **Проверить лендинг в браузере на публичном хосте** — весь смоук делался curl'ом и
  локальным рендером; глазами на `сарафан.вмалмыже.рф/regions/links` не смотрели.
