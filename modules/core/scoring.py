...
class PostScorer:
    ...
    def calculate_score(self, post: Any, ai_relevance: int = 50, source_priority: int = 50) -> int:
        """
    ...
    def get_score_breakdown(
        self, post: Any, ai_relevance: int = 50, source_priority: int = 50
    ) -> Dict[str, Any]:
        """
...
class ScorerPresets:
    ...
    def postopus_style() -> PostScorer:
        ...
        """
        return PostScorer(
            engagement_weight=0.4, relevance_weight=0.3, recency_weight=0.2, source_weight=0.1
        )
    ...
    def ai_heavy() -> PostScorer:
        ...
        """
        return PostScorer(
            engagement_weight=0.2, relevance_weight=0.5, recency_weight=0.2, source_weight=0.1
        )
    ...
    def viral_hunter() -> PostScorer:
        ...
        """
        return PostScorer(
            engagement_weight=0.6, relevance_weight=0.1, recency_weight=0.2, source_weight=0.1
        )
