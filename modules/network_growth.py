...
1. **История мелкая и с рваным краем.** Первый возможный снимок —
   2026-06-08 (миграция 033 выкачена 06-07, таска бежит в 04:00). «Полгода»
   поэтому честно вырождается в «за всё время (с 8 июня)» и станет настоящими
   полугодом само, когда история дорастёт: окно, которое не помещается в
   данные, помечается ``partial`` и подписывается своей фактической датой.
