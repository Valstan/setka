...
class DuplicationDetector:
    ...
    async def _check_lip_duplicate(self, owner_id: int, post_id: int) -> Dict[str, Any]:
    ...
    async def _check_media_duplicate(
        self, attachments: List[Dict[str, Any]], region_id: Optional[int] = None
    ) -> Dict[str, Any]:
    ...
    async def _check_text_duplicate(
        self, text: str, region_id: Optional[int] = None
    ) -> Dict[str, Any]:
    ...
    async def get_similar_posts(
        self, text: str, region_id: Optional[int] = None, limit: int = 5
    ) -> List[Post]:
        """
