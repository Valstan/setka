...
# Часть хештега по теме (кириллица, без #), к региональной части из heshteg_local пристыковывается в heshteg
...
def resolve_digest_hashtags(
    ...
    """
    Возвращает (список тематических тегов без #, один или несколько) и локальный тег региона с # или "".
