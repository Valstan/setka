...
#
# v2 (2026-08-31): сама графика НЕ менялась — бамп нужен, чтобы переприменить
# оформление к десяти сообществам порции 1. Их обложки уехали не здесь, а на
# загрузке: `group_setup_vk.COVER_CROP` просил у ВК прямоугольник 1590×400 из
# картинки 2560×644, и ВК отрезал 38% ширины — заголовок обрывался на 71%.
# Байты картинки прежние, поэтому без бампа скрипт счёл бы работу сделанной и
# ничего не переслал.
TEMPLATE_VERSION = 2
