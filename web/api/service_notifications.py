...
from modules.service_notifications import NotificationType, service_notifications
...
async def get_notifications_by_type(notification_type: str):
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                status_code=400, detail=f"Invalid notification type: {notification_type}"
            )
...
async def clear_notifications():
    ...
    try:
        ...
        return NotificationResponse(
            success=True, message="All notifications cleared", data={"count": 0}
        )
    except Exception as e:
...
async def get_notification_types():
    ...
    try:
        ...
        return {"success": True, "data": {"types": types, "count": len(types)}}
    except Exception as e:
