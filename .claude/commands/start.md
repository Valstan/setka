...
Если с последней дистилляции прошло **> 7 дней** — добавить в отчёт (Шаг 6) напоминание:
«⏰ Дистилляция Корпуса не делалась N дней — запустить `/distill`?». Облачной
рутины-дистиллятора больше нет — дистилляция делается только из чата по `/distill`.
Если файла нет или < 7 дней — молчать.
