...
Открыть витрину на её локальном порту. Первый вход — дефолтная пара логин/пароль из документации Grafana; **сменить сразу**, до того как порт станет доступен снаружи.
